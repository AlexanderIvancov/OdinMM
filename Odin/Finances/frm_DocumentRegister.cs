...
{
    public partial class frm_DocumentRegister : KryptonForm
    {
        public frm_DocumentRegister()
        {
            InitializeComponent();
            wait = new ProgressForm(this);
            ED = new ExportData(this.gv_List, "DocumentRegister.xls", this.Name);
        }
        ProgressForm wait;
        ...
        #region Controls
        private void frm_DocumentRegister_Load(object sender, EventArgs e)
        {
            LoadColumns(gv_List);
