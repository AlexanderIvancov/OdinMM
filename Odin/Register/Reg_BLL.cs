...
namespace Odin.Register
{
    public class Reg_BLL
    {
        ...
        public void AddRatioOperation(int artid, int stageid, string operation, string formula, int useonce, int operno, string comments, int checkbefore, string instructions, int prodstageid)
        {
            SqlConnection sqlConn = new SqlConnection(sConnStr);
            ...
            sqlComm.Parameters.AddWithValue("@prodstageid", prodstageid);
        ...
        public void EditRatioOperation(int id, string operation, string formula, int useonce, int operno, string comments, int checkbefore, string instructions, int prodstageid)
        {
            SqlConnection sqlConn = new SqlConnection(sConnStr);
