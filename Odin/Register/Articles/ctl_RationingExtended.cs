    ...
    public partial class ctl_RationingExtended : UserControl
    {
        ...
        public void EditOperation()
        {
            ...
            if (_operid != 0)
            {
                ...
                {
                    Reg.EditRatioOperation(frm.Id, frm.Operation, frm.Formula, frm.UsingOnce, frm.OperNO, frm.Comments, 0, "", 0);
        ...
        private void btn_AddOper_Click(object sender, EventArgs e)
        {
                ...
                && ArtId != 0)
            {
                ...
                if (result == DialogResult.OK)
                {
                    Reg.AddRatioOperation(ArtId, _stageid, frm.Operation, frm.Formula, frm.UsingOnce, frm.OperNO, frm.Comments, 0, "", 0);
                    FillOpers(ArtId, _stageid);
                    ShowTotals(ArtId);
                }
            }
