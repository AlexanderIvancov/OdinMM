...
{
    public partial class frm_RatioTab : KryptonForm
    {
        public frm_RatioTab()
        {
            InitializeComponent();
            ED = new ExportData(gv_List, "RatioList.xls", this.Name);
        }
        ...
        public void SetCellsColor()
        {
            ...
            //{
            //    if (Convert.ToInt32(row.Cells["cn_isstarted"].Value) == 0)
        ...
        private void frm_RatioTab_Load(object sender, EventArgs e)
        {
