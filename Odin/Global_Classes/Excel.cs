...
namespace Odin.Global_Classes
{
    public class Excel : IDisposable
    {
        ...
        public const string UID15 = "Excel.Application.15";
        public const string UID16 = "Excel.Application.16";
        ...
        public Excel()
        {
            ...
            string type = Type.GetTypeFromProgID(UID) == null ? UID15 : UID;

            oExcel = Activator.CreateInstance(Type.GetTypeFromProgID(type));
