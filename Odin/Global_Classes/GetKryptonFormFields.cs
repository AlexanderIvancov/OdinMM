...
public static class ObjectExtension
{
    ...
    {
    //    using (SqlConnection connection = new SqlConnection(Odin.Properties.Settings.Default.OdinDBConnectionString))
    //    {
    //        connection.Open();
    ...
    public static Dictionary<string, string> SetKryptonFormFields(string form, SqlConnection connection)
    {
        ...
        string sql = $@"SELECT field, string FROM BAS_FormFields WHERE form = '{form}' and lang = '{df.UserLang}'";
