...
namespace Odin.Warehouse.Reports
{
    public partial class frm_TurnoverReports : BaseForm
    {
        ...
        {
            DataTable data;
            data = (DataTable)Helper.getSP("sp_BookTurnover2110", txt_CreatDateFrom.Value == null ? "" : txt_CreatDateFrom.Value.ToString().Trim(),
        ...
        {
            DataTable data;
            data = (DataTable)Helper.getSP("sp_BookTurnover2120", txt_CreatDateFrom.Value == null ? "" : txt_CreatDateFrom.Value.ToString().Trim(),
                                           txt_CreatDateTill.Value == null ? "" : txt_CreatDateTill.Value.ToString().Trim());
        ...
        {
            DataTable data;
            data = (DataTable)Helper.getSP("sp_BookTurnover2130", txt_CreatDateFrom.Value == null ? "" : txt_CreatDateFrom.Value.ToString().Trim(),
                                           txt_CreatDateTill.Value == null ? "" : txt_CreatDateTill.Value.ToString().Trim());
