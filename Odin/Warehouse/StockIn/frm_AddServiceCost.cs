...
{
    public partial class frm_AddServiceCost : KryptonForm
    {
        public frm_AddServiceCost()
        {
            InitializeComponent();
            ED = new ExportData(this.gv_List, "Services.xls", this.Name);
        }
        ...
        public void RecalcTotals()
        {
            ...
            foreach (DataGridViewRow row in this.gv_List.Rows)
            {
                if (Convert.ToInt32(row.Cells["chk_Add"].Value) != 0)
                    _cost = _cost + Convert.ToDouble(row.Cells["cn_unitprice"].Value);
            }
        ...
        private void frm_AddServiceCost_Load(object sender, EventArgs e)
        {
            LoadColumns(gv_List);
        }
