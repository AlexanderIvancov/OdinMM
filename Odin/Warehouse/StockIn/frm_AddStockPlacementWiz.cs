...
namespace Odin.Warehouse.StockIn
{
    ...
    public partial class frm_AddStockPlacementWiz : KryptonForm
    {
        public frm_AddStockPlacementWiz()
        {
            InitializeComponent();
        ...
        public void FillList()
        {
            ...
            var data = StockIn_BLL.getStockNotPlaced(0, cmb_IncomeDoc1.IncomeDocId);
