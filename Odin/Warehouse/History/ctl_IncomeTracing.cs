...
{
    public partial class ctl_IncomeTracing : UserControl
    {
        public ctl_IncomeTracing()
        {
            InitializeComponent();
            ED = new ExportData(this.gv_List, "LabelTracing.xls", this.Name);
        }
        ...
        private void ctl_IncomeTracing_Load(object sender, EventArgs e)
        {
            LoadColumns(gv_List);
        }
    }
