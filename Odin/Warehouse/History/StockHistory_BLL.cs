...
namespace Odin.Warehouse.History
{
    public class StockHistory_BLL
    {
        ...
        public static DataTable getIncomesHistorySum(int _headid, int _opertypeid, int _typeid, int _supid, int _batchid, int _salesorderid, int _artid, string _article,
                                                    string _datefrom, string _datetill, string _suparticle)
        {
            string query = "sp_StockHistoryIncomesSum";
        ...
        public static DataTable getOutcomesHistorySum(int _headid, int _opertypeid, int _typeid, int _custid, int _batchid, int _custorderid, int _artid, string _article,
                                                   string _datefrom, string _datetill, string _custarticle, int _placeid, int _groupbybatch)
        {
            string query = "sp_StockHistoryOutcomesSum";
        ...
        public static DataTable getMovementHistorySum(int _headid, int _opertypeid, int _typeid, int _batchid, int _salesorderid, int _artid, string _article,
                                                    string _datefrom, string _datetill, int _placefrom, int _placeto)
        {
            string query = "sp_StockHistoryMovementsSum";
