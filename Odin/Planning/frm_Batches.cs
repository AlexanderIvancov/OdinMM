    ...
    public partial class frm_Batches : BaseForm
    {
        ...
        public void ShowEdit()
        {
            ...
            if (_batchid != 0)
            {
                ...
                frm.ctl_CreatBatchDets1.ArticleId = PlanBll.BatchArtId;
                frm.ctl_CreatBatchDets1.fOldArticleId = PlanBll.BatchArtId;
        ...
        private void btn_AddNew_Click(object sender, EventArgs e)
        {
            ...
            //                                        QtyInCO - QtyInBatch(), EndDate, "");

            //frm.ctl_CreatBatchDets1.StartDate = ResDate;
            //frm.ctl_CreatBatchDets1.EndDate = EndDate;
