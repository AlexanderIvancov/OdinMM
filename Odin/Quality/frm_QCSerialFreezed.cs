...
namespace Odin.Quality
{
    public partial class frm_QCSerialFreezed : KryptonForm
    {
        ...
        {
            var data = (DataTable)Helper.getSP("sp_SelectQCSerialFreezed", BatchId, DAL.UserLang, txt_Serial.Text);
        ...
        private void btn_AddNew_Click(object sender, EventArgs e)
        {
            ...
            {
                _showingModal = false;
                Helper.getSP("sp_AddSerialFreezed", frm.StageId, frm.BatchId, frm.LaunchId, rusToEng(frm.Serial), frm.Position, frm.FreezedReasonId);
        ...
        private void btn_Delete_Click(object sender, EventArgs e)
        {
            ...
            {
                Helper.getSP("sp_DeleteSerialFreezed", rusToEng(gv_List.CurrentRow.Cells["cn_serial"].Value.ToString()));
