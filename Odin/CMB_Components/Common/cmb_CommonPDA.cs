...
{
    public delegate void CommonPDAEventHandler(object sender);

    public partial class cmb_CommonPDA : UserControl
    {

        public cmb_CommonPDA()
        {
            InitializeComponent();
        ...
        public event CommonPDAEventHandler SelectedValueChanged;
        ...
        private void btn_AdvView_Click(object sender, EventArgs e)
        {
            ...
            frm_CommonPDA popup = new frm_CommonPDA();
            popup.cmb_CommonPDAOne = this;
