...
namespace Odin.CMB_Components.OutcomeDocs
{
    public partial class frm_OutDocs : KryptonForm
    {
        ...
        {
            var data = (System.Data.DataTable)Helper.getSP("sp_OutcomeDocsSelectLike", Beg);
        ...
        {
            var data = (System.Data.DataTable)Helper.getSP("sp_OutcomeDocsSelectLikeAll", Beg);
        ...
        private void btn_Edit_Click(object sender, EventArgs e)
        {
            ...
            if (_id != 0)
            {
                ...
                {
                    _showingModal = false;
                    Helper.getSP("sp_EditOutcomeDocHead", _id, frm.DocDate, frm.Comments, frm.TypeOff, frm.ReasonId, frm.BatchId);
                    FillData(frm.OutDoc);
                    ((cmb_OutcomeDocs)cmb_OutcomeDocsOne).OutcomeDocSendSave();
                }
                if (result == DialogResult.Cancel)
        ...
        private void btn_Delete_Click(object sender, EventArgs e)
        {
            ...
            {
                Helper.getSP("sp_DeleteOutcomeDocHead", _id);
