...
{
    public partial class frm_DeliveryIndicator : KryptonForm
    {
        public frm_DeliveryIndicator()
        {
            InitializeComponent();
        ...
        {
            var data = CO_BLL.getSalesDeliveryIndicators(txt_From.Text.Trim() == "" ? System.DateTime.Now.AddMonths(-6).ToShortDateString() : txt_From.Text.Trim(),
